...
<table id="bara" align="center" border="0" width="80%">
    <tr>
        <td width="55%">Όνομα Πελάτη: <b><?= $_SESSION['uname']; ?></b></td>
        <td width="15%">Συνέχεια αγορών: <a href="menu.php"><img src="./images/menu.png"
                                                                 style="width:20px; height:20px"/></a></td>
        <td width="10%">Αποσύνδεση: <a href="logout.php"><img src="./images/logout.png"
                                                              style="width:20px; height:20px"/></a></td>
    </tr>
</table>
</br>
<table id="lista2" align="center" border="1" width="80%">
    ...
    if ($apotelesma > 0) {
        while ($tbl_row = mysqli_fetch_row($tbl_q)) {
            ...
            <tr>
                ...
                <td><input type="number" name="posotita" value="<?= $posotita; ?>" maxlength="1" max="<?= $maxp; ?>"
                           min="1" onchange="val(this.value)">
                    <button type="button" onclick="updt(<?= $tbl_row[0] ?>);">Αλλαγή</button>
                </td>
                <td><?= number_format($posotita * ($tbl_row[4] + $tbl_row[5]), 2, ',', '') ?> €</td>
                <td><a href="bskt_del.php?pid=<?= $tbl_row[0]; ?>"><img src="./images/recycle_bin.png"
    ...
    ?>
    <tr>
        <td colspan="5"><b>Σύνολο:</b></td>
        <td colspan="2"><b><?= number_format($synolo, 2, ',', ''); ?> €</b></td>
    </tr>
</table>
<table align="center">
    <tr>
