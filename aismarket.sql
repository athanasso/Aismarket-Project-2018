...
-- ----------------------------
BEGIN;
INSERT INTO `USERS` VALUES ('1', 'rania', 'rania@teipir.gr', '12<34', '1'), ('2', 'user', 'user@edu.gr', '4s3r', '1'), ('3', 'Raymond Reddington', 'red@bl.com', 'r3d', '1'), ('4', 'Olivia Pope', 'liv@wh.com', '0l1v14', '1'), ('5', 'Violet Crawley', 'viocraw@da.co.uk', 'cr4Wl3y', '1');
COMMIT;
